...
CREATE TABLE `tbl_categoria` (
  ...
  `nombre_categoria` varchar(200) COLLATE utf8_spanish_ci NOT NULL
...
CREATE TABLE `tbl_comprobante` (
  ...
  `secuencia` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `tbl_correos` (`id_correo`, `correo`, `id_cliente`, `principal`, `activo`) VALUES
(1, 'ammiel16@gmail.com', 1, 1, 0),
(2, 'yes@dd.com', 1, 0, 1),
(3, 'ammiel16@gmail.com', 1, 1, 1),
(4, 'eee@ff.com', 1, 0, 0),
(5, 'sss@ddd.cpom', 1, 1, 0),
(6, 'asas@ll.com', 1, 0, 0),
(7, 'sss@ddd.com', 1, 0, 1),
(8, 'rrr@dd.com', 4, 0, 0),
(9, 'ttt@dd.com', 4, 1, 1),
(10, 'errr@dfd.com', 4, 1, 1),
(11, 'ttt@ddd.com', 4, 0, 1),
(12, 'yy@wewe.com', 28, 0, 0),
(13, 'dd@ff.com', 28, 1, 1),
(14, 'ammiel16@gmail.com', 29, 0, 1),
(15, 'luis@gmail.com', 29, 1, 1),
(16, 'robertit45@gmail.com', 45, 1, 1);
...
--
-- Table structure for table `tbl_documento_cliente`
--

CREATE TABLE `tbl_documento_cliente` (
...
--
-- Dumping data for table `tbl_documento_cliente`
--

INSERT INTO `tbl_documento_cliente` (`id_documento`, `id_cliente`, `nombre`, `size`, `url`, `descripcion`, `activo`) VALUES
(1, 1, 'Diagram-RC-REST-v2.1.png', 20990, 'resources/files/Diagram-RC-REST-v2.1.png', 'eerrr', 1),
(2, 1, '54350291_369883133863578_5901737470789156864_n.jpg', 58475, 'resources/files/54350291_369883133863578_5901737470789156864_n.jpg', '', 1),
(3, 1, 'atento_screen.png', 161620, 'resources/files/atento_screen.png', 'asasasas', 1),
(4, 1, 'sample.pdf', 1975, 'resources/files/sample.pdf', 'asass', 1),
(5, 1, 'PROPUESTA APP MOVIL.docx', 36216, 'resources/files/PROPUESTA APP MOVIL.docx', 'sdsdsd', 1),
(6, 5, 'PROPUESTA APP MOVIL.pdf', 86006, 'resources/files/PROPUESTA APP MOVIL.pdf', 'rewd', 1),
(7, 45, 'atento_screen.png', 161620, 'resources/files/atento_screen.png', 'Screenshot atento', 1);
...
--
-- Table structure for table `tbl_nominacion`
--

CREATE TABLE `tbl_nominacion` (
  `id_nominacion` int(11) NOT NULL,
  `nombre_nominacion` varchar(200) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Dumping data for table `tbl_nominacion`
--

INSERT INTO `tbl_nominacion` (`id_nominacion`, `nombre_nominacion`) VALUES
(1, 'Kilos'),
(2, 'Gramos'),
(3, 'Litros');
...
--
-- Table structure for table `tbl_operador`
--

CREATE TABLE `tbl_operador` (
  `id_operador` int(11) NOT NULL,
  `nombre_operador` varchar(200) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Dumping data for table `tbl_operador`
--

INSERT INTO `tbl_operador` (`id_operador`, `nombre_operador`) VALUES
(1, 'Claro'),
(2, 'Movistar'),
(3, 'Entel'),
(4, 'Bitel');
...
CREATE TABLE `tbl_telefonos` (
  ...
  `numero_telefono` varchar(200) COLLATE utf8_spanish_ci NOT NULL,
  `id_cliente` int(11) NOT NULL,
  `activo` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `tbl_telefonos` (`id_telefono`, `id_operador`, `numero_telefono`, `id_cliente`, `activo`) VALUES
(3, 1, '8888880', 1, 0),
(4, 3, '777778888', 3, 1),
(6, 1, '00000000', 1, 0),
(7, 1, '34556', 1, 1),
...
ALTER TABLE `tbl_comprobante`
  ...
  ADD KEY `fk_tipo_comprobante` (`id_tipo_comprobante`),
  ADD KEY `fk_cliente_1` (`id_cliente`);

--
-- Indexes for table `tbl_correos`
--
...
--
ALTER TABLE `tbl_detalle_comprobante`
...
ALTER TABLE `tbl_menu`
  ...
  ADD KEY `fk_rol_menu` (`id_rol`);

--
-- Indexes for table `tbl_nominacion`
--
ALTER TABLE `tbl_nominacion`
  ADD PRIMARY KEY (`id_nominacion`);

--
-- Indexes for table `tbl_operador`
--
...
ALTER TABLE `tbl_productos`
  ...
  ADD KEY `fk_nominacion` (`id_nominacion`);
...
--
-- Indexes for table `tbl_telefonos`
--
ALTER TABLE `tbl_telefonos`
  ADD PRIMARY KEY (`id_telefono`),
  ADD KEY `fk_telefono` (`id_cliente`),
...
--
-- AUTO_INCREMENT for table `tbl_correos`
--
ALTER TABLE `tbl_correos`
  MODIFY `id_correo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tbl_detalle_comprobante`
--
ALTER TABLE `tbl_detalle_comprobante`
  MODIFY `id_detalle_comprobante` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_documento_cliente`
--
ALTER TABLE `tbl_documento_cliente`
...
--
-- AUTO_INCREMENT for table `tbl_nominacion`
--
ALTER TABLE `tbl_nominacion`
  MODIFY `id_nominacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_operador`
--
ALTER TABLE `tbl_operador`
...
--
ALTER TABLE `tbl_comprobante`
  ADD CONSTRAINT `fk_cliente_1` FOREIGN KEY (`id_cliente`) REFERENCES `tbl_clientes` (`id_cliente`),
  ADD CONSTRAINT `fk_tipo_comprobante` FOREIGN KEY (`id_tipo_comprobante`) REFERENCES `tbl_tipo_comprobante` (`id_tipo`);

--
-- Constraints for table `tbl_correos`
--
ALTER TABLE `tbl_correos`
  ADD CONSTRAINT `fk_cliente` FOREIGN KEY (`id_cliente`) REFERENCES `tbl_clientes` (`id_cliente`);

--
-- Constraints for table `tbl_detalle_comprobante`
--
ALTER TABLE `tbl_detalle_comprobante`
  ADD CONSTRAINT `fk_comprobante` FOREIGN KEY (`id_comprobante`) REFERENCES `tbl_comprobante` (`id_comprobante`),
  ADD CONSTRAINT `fk_producto` FOREIGN KEY (`id_producto`) REFERENCES `tbl_productos` (`id_producto`);

--
-- Constraints for table `tbl_documento_cliente`
--
ALTER TABLE `tbl_documento_cliente`
  ADD CONSTRAINT `fk_documento_cliente` FOREIGN KEY (`id_cliente`) REFERENCES `tbl_clientes` (`id_cliente`);

--
-- Constraints for table `tbl_menu`
--
ALTER TABLE `tbl_menu`
  ADD CONSTRAINT `fk_rol_menu` FOREIGN KEY (`id_rol`) REFERENCES `tbl_rol` (`id_rol`);
...
ALTER TABLE `tbl_productos`
  ...
  ADD CONSTRAINT `fk_nominacion` FOREIGN KEY (`id_nominacion`) REFERENCES `tbl_nominacion` (`id_nominacion`);

--
-- Constraints for table `tbl_telefonos`
--
ALTER TABLE `tbl_telefonos`
  ADD CONSTRAINT `fk_operador` FOREIGN KEY (`id_operador`) REFERENCES `tbl_operador` (`id_operador`),
  ADD CONSTRAINT `fk_telefono` FOREIGN KEY (`id_cliente`) REFERENCES `tbl_clientes` (`id_cliente`);
